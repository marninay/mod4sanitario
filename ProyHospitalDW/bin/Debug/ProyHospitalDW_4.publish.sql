/*
Deployment script for BDHospitalDW
...
:setvar DefaultDataPath "C:\sqlserverdata\bd\"
:setvar DefaultLogPath "C:\sqlserverdata\logs\"
...
GO
PRINT N'Creating Table [dbo].[Dim_Hospital]...';
...
GO
PRINT N'Creating Table [dbo].[Dim_Medico]...';
...
GO
PRINT N'Creating Table [dbo].[Dim_Paciente]...';
...
GO
PRINT N'Creating Table [dbo].[Dim_Servicio]...';
...
GO
PRINT N'Creating Table [dbo].[Dim_Tiempo]...';
...
GO
PRINT N'Creating Table [dbo].[Hecho_Atencion_Medica]...';
...
GO
PRINT N'Creating Foreign Key unnamed constraint on [dbo].[Dim_Medico]...';


GO
ALTER TABLE [dbo].[Dim_Medico]
    ADD FOREIGN KEY ([codHospital]) REFERENCES [dbo].[Dim_Hospital] ([codHospital]);


GO
PRINT N'Creating Foreign Key unnamed constraint on [dbo].[Hecho_Atencion_Medica]...';


GO
ALTER TABLE [dbo].[Hecho_Atencion_Medica]
