...
GO
PRINT N'Quitando Clave externa restricción sin nombre en [dbo].[MedicoServicio]...';


GO
ALTER TABLE [dbo].[MedicoServicio] DROP CONSTRAINT [FK__MedicoServi__DNI__5535A963];
...
GO
ALTER TABLE [dbo].[MedicoServicio] DROP CONSTRAINT [FK__MedicoSer__idSer__5629CD9C];
...
DECLARE tableconstraintnames CURSOR LOCAL FORWARD_ONLY
    FOR SELECT SCHEMA_NAME([schema_id]),
               ...
               0
        FROM   [sys].[objects]
        WHERE  [parent_object_id] IN (OBJECT_ID(N'dbo.MedicoServicio'))
               AND [type] IN (N'F', N'C')
